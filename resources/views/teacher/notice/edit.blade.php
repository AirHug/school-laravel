...
@section('body')
    ...
    <p>
        <textarea class="editor" name="content" rows="35" cols="160" upLinkUrl="{{url("upload")}}" upLinkExt="zip,rar,txt" upImgUrl="{{url("upload")}}" upImgExt="jpg,jpeg,gif,png" upFlashUrl="{{url("upload")}}" upFlashExt="swf" upMediaUrl="{{url("upload")}}" upMediaExt="avi">{{$notice->content}}</textarea>
    </p>
@endsection