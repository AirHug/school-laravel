...
@section("css")
<!-- /样式 -->
<link href="{{asset("site/css/Revolut.min.css")}}" rel="stylesheet" />
<!--[if lte IE 8]>
        ...
        <div class="container">
            <ul class="row ">
                <li class="logo col-md-6">
                    <img src="{{asset("site/img/logo4.png")}}"/>
                </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="content_left col-md-4">
                            ...
                            <form action="{{url("hx")}}" class="login" method="post">
                                <ul class="form-inline">
                                    <li class="form-group">
                                        ...
                                        <input type="user_name" class="form-control" id="username" name="username" placeholder="用户名">
                                        {{ csrf_field() }}
                                    </li>
                                </ul>
                                <ul class="form-inline">
                        ...
                        <div class="col-md-12 cls white">
                            <div class="info_btn">
                                <ul class="col-md-12">
                                    <li class="col-md-6"><a href="{{url("jng")}}" class="btn btn-danger">中小学革命史</a>
                                    </li>
                                    <li class="col-md-6"><a href="{{url("jwc")}}" class="btn btn-danger">教务处站点页</a>
                                    </li>
                                </ul>
                                <ul class="col-md-12">
                                    <li class="col-md-6"><a href="{{url("hx")}}" class="btn btn-danger">教师教务系统</a></li>
                                    <li class="col-md-6"><a href="{{url("zzh")}}" class="btn btn-danger">学生选课系统</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8 content_right">
                        <div class="col-md-12 white class_content slideTxtBox">
                            <div class="hd titles">
                                <ul class="title_nav">
                                    <li class="on">中小学革命史|Revolution</li>
                                </ul>
                                <div class="more">
                                    <a href="{{"L",2}}">更多<span>>></span></a>
                                </div>
                            </div>
